...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="index.html">
            <img src="{{asset('org/Dashkit-1.1.2/assets')}}/img/logo.svg" class="navbar-brand-img
          mx-auto" alt="...">
        </a>
            ...
            <div class="dropdown">
                ...
                <a href="#!" id="sidebarIcon" class="dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="avatar avatar-sm avatar-online">
                        <img src="{{asset('org/Dashkit-1.1.2/assets')}}/img/avatars/profiles/avatar-1.jpg" class="avatar-img rounded-circle" alt="...">
                    </div>
                </a>
